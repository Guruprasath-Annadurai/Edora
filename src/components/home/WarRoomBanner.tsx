    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 2 }}>
          <span style={{ fontSize: 12, fontWeight: 800, letterSpacing: '0.08em', color: '#EF4444', textTransform: 'uppercase' }}>
            WAR ROOM
          </span>
          <span style={{
        ...
        <p style={{ fontSize: 13, fontWeight: 600, color: 'var(--ink-850)', lineHeight: 1.3 }}>
