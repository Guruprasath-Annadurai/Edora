  ...
  return (
    <div className="h-full flex flex-col" style={{ background: 'transparent' }}>
      ...
      <div className="shrink-0 px-4 py-3 flex items-center gap-3"
        style={{ background: 'var(--v2-card)', borderBottom: '1px solid var(--v2-border)' }}>
        ...
        <div className="flex-1">
          <h2 className="font-heading font-bold text-sm" style={{ color: 'var(--v2-text-1)' }}>Invite & Earn XP</h2>
          <p className="text-xs" style={{ color: 'var(--v2-text-4)' }}>Share Edora, get rewarded</p>
        </div>
        <Gift size={18} style={{ color: 'var(--v2-primary)' }} />
      </div>

      <div className="flex-1 overflow-y-auto pb-nav px-4 pt-5 flex flex-col gap-4">
        {/* Hero */}
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }}
          className="rounded-3xl p-5 relative overflow-hidden v2-card">
          <div className="relative">
            <p className="text-xs font-semibold uppercase tracking-wider mb-2" style={{ color: 'var(--v2-text-4)' }}>Your referral code</p>
            <div className="flex items-center gap-3 mb-4">
              <span className="font-heading text-3xl font-black tracking-[0.15em]" style={{ color: 'var(--v2-text-1)' }}>{referralCode}</span>
            ...
            <div className="grid grid-cols-2 gap-2 mb-4">
              <div className="rounded-2xl p-3" style={{ background: 'var(--v2-elevated)' }}>
                <p className="text-xs mb-0.5" style={{ color: 'var(--v2-text-4)' }}>You earn</p>
                <p className="font-heading font-bold text-lg v2-tnum" style={{ color: 'var(--v2-text-1)' }}>+100 XP</p>
                <p className="text-xs" style={{ color: 'var(--v2-text-4)' }}>per friend who joins</p>
              </div>
              <div className="rounded-2xl p-3" style={{ background: 'var(--v2-elevated)' }}>
                <p className="text-xs mb-0.5" style={{ color: 'var(--v2-text-4)' }}>Friend gets</p>
                <p className="font-heading font-bold text-lg v2-tnum" style={{ color: 'var(--v2-text-1)' }}>+50 XP</p>
                <p className="text-xs" style={{ color: 'var(--v2-text-4)' }}>bonus on signup</p>
              </div>
            </div>

            <motion.button whileTap={{ scale: 0.97 }} onClick={shareLink}
              className="w-full py-3.5 rounded-2xl font-semibold text-sm flex items-center justify-center gap-2 v2-btn-primary">
        ...
        {/* Bonus milestones */}
        <div className="rounded-2xl p-4 v2-card">
          <p className="text-xs font-semibold uppercase tracking-wide mb-3" style={{ color: 'var(--v2-text-4)' }}>Bonus XP milestones</p>
          {[
              ...
              return (
                <motion.div key={r.referee_id} initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.04 }}
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-semibold truncate" style={{ color: 'var(--v2-text-1)' }}>{r.referee_name}</p>
