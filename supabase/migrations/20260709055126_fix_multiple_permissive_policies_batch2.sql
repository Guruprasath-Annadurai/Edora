...
drop policy if exists "inst_mem_admin_write" on "institution_members";
drop policy if exists "inst_mem_self_join" on "institution_members";
...
drop policy if exists "inst_admin_all" on "institutions";
drop policy if exists "inst_member_read" on "institutions";
drop policy if exists "inst_admin_insert" on "institutions";
create policy "inst_admin_insert" on "institutions" for insert with check ((select auth.uid()) = admin_user_id);
drop policy if exists "inst_admin_update" on "institutions";
...
drop policy if exists "inst_admin_delete" on "institutions";
...
drop policy if exists "service_write" on "knowledge_graph";
drop policy if exists "knowledge_graph_service_insert" on "knowledge_graph";
create policy "knowledge_graph_service_insert" on "knowledge_graph" for insert with check (auth.role() = 'service_role');
drop policy if exists "knowledge_graph_service_update" on "knowledge_graph";
...
drop policy if exists "knowledge_graph_service_delete" on "knowledge_graph";
...
drop policy if exists "lep_own_write" on "live_event_participants";
drop policy if exists "lep_insert" on "live_event_participants";
create policy "lep_insert" on "live_event_participants" for insert with check ((select auth.uid()) = user_id);
drop policy if exists "lep_update" on "live_event_participants";
...
drop policy if exists "lep_delete" on "live_event_participants";
...
drop policy if exists "live_events_service_write" on "live_events";
drop policy if exists "live_events_service_insert" on "live_events";
create policy "live_events_service_insert" on "live_events" for insert with check (auth.role() = 'service_role');
drop policy if exists "live_events_service_update" on "live_events";
...
drop policy if exists "live_events_service_delete" on "live_events";
...
drop policy if exists "live_rooms_host_write" on "live_study_rooms";
drop policy if exists "live_rooms_insert" on "live_study_rooms";
create policy "live_rooms_insert" on "live_study_rooms" for insert with check ((select auth.uid()) = host_id);
drop policy if exists "live_rooms_update" on "live_study_rooms";
...
drop policy if exists "live_rooms_delete" on "live_study_rooms";
...
drop policy if exists "ncert_paragraphs_service_write" on "ncert_paragraphs";
drop policy if exists "ncert_paragraphs_service_insert" on "ncert_paragraphs";
create policy "ncert_paragraphs_service_insert" on "ncert_paragraphs" for insert with check (auth.role() = 'service_role');
drop policy if exists "ncert_paragraphs_service_update" on "ncert_paragraphs";
...
drop policy if exists "ncert_paragraphs_service_delete" on "ncert_paragraphs";
