...
drop policy if exists "users_own_certs" on "novo_certifications";
drop policy if exists "certs_insert" on "novo_certifications";
create policy "certs_insert" on "novo_certifications" for insert with check ((select auth.uid()) = user_id);
drop policy if exists "certs_update" on "novo_certifications";
...
drop policy if exists "certs_delete" on "novo_certifications";
create policy "certs_delete" on "novo_certifications" for delete using ((select auth.uid()) = user_id);
drop policy if exists "cert_public_share" on "novo_certifications";
drop policy if exists "certs_read" on "novo_certifications";
...
drop policy if exists "profiles_own_update_secured" on "profiles";
...
drop policy if exists "question_translations_service_write" on "question_translations";
drop policy if exists "question_translations_auth_insert" on "question_translations";
drop policy if exists "question_translations_insert" on "question_translations";
...
drop policy if exists "question_translations_service_update" on "question_translations";
...
drop policy if exists "question_translations_service_delete" on "question_translations";
...
drop policy if exists "reopt_service_all" on "roadmap_reoptimizations";
drop policy if exists "reopt_service_insert" on "roadmap_reoptimizations";
create policy "reopt_service_insert" on "roadmap_reoptimizations" for insert with check (auth.role() = 'service_role');
drop policy if exists "reopt_service_update" on "roadmap_reoptimizations";
...
drop policy if exists "reopt_service_delete" on "roadmap_reoptimizations";
create policy "reopt_service_delete" on "roadmap_reoptimizations" for delete using (auth.role() = 'service_role');
drop policy if exists "reopt_own_read" on "roadmap_reoptimizations";
drop policy if exists "reopt_read" on "roadmap_reoptimizations";
...
drop policy if exists "solved_examples_service_write" on "solved_examples";
drop policy if exists "solved_examples_service_insert" on "solved_examples";
create policy "solved_examples_service_insert" on "solved_examples" for insert with check (auth.role() = 'service_role');
drop policy if exists "solved_examples_service_update" on "solved_examples";
...
drop policy if exists "solved_examples_service_delete" on "solved_examples";
